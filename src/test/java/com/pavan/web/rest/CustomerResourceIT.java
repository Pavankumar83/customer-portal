...
public class CustomerResourceIT {
    ...
    private static final IdentificationType DEFAULT_IDENTIFICATION_TYPE = IdentificationType.PASSPORT;
    private static final IdentificationType UPDATED_IDENTIFICATION_TYPE = IdentificationType.NATIONAL_ID;

    private static final CustomerType DEFAULT_CUSTOMER_TYPE = CustomerType.LEGAL_ENTITY;
    private static final CustomerType UPDATED_CUSTOMER_TYPE = CustomerType.INDIVIDUAL;
    ...
    public void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.isDeleted()).isEqualTo(DEFAULT_DELETED);
    }
    ...
    public void updateCustomer() throws Exception {
        ...
        assertThat(testCustomer.isDeleted()).isEqualTo(UPDATED_DELETED);
    }
